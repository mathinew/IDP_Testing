...
HomePage_Topbar
    ...
    Element Text Should Be    xpath://h6[text()='Grievance Redressal Management']    Grievance Redressal Management 
...
User_details
    Element Should Be Visible    css:span.username    
    Element Should Be Visible    css:div.userdetail    
    Element Should Be Visible    css:img.UserHeadericon   

Home_page_menu
    Element Should Be Visible    xpath://div[@class='offi_menu' and text()='Menu'] 
